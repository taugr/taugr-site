---
title: 'Announcing SecretBox symmetric crypto library for .NET'
description: "I've written a small .NET crypto library 'SecretBox' for symmetric key encryption using the Gimli permutation."
date: 2019-06-27
tags: ['crypto', 'csharp']
draft: false
originalUrl: 'https://tomauger.gitlab.io/posts/2019/2019-06-27-secret-box/'
archivePath: '2019-06-27-secret-box'
---

> Archived from the old blog. Original URL: [https://tomauger.gitlab.io/posts/2019/2019-06-27-secret-box/](https://tomauger.gitlab.io/posts/2019/2019-06-27-secret-box/).

I've written a small .NET crypto library 'SecretBox' for symmetric key encryption using the Gimli permutation.

<img align="right" src="https://github.com/tom-auger/secretbox/raw/master/logo.png">

The SecretBox construction is a port of `hydro_secretbox` from [libhydrogen](https://github.com/jedisct1/libhydrogen). The Gimli primitive is a C# translation of the `c-ref` implementation of the Gimli permutation, for which the source code and specification can be obtained [here](https://gimli.cr.yp.to/).
...
View the source code on [GitHub](https://github.com/tom-auger/secretbox)

The code is licensed under ISC, so you can do whatever you want with it.
However if you find bugs I would appreciate raising and issue or a pull request with a fix.
